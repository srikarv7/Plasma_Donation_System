...
public class OrganMatchByRecipientJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblMatchButton = new javax.swing.JButton();
        ...
        tbldonorInfo.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Donor Name", "Network", "Current Plasma Availabilty"
            }
        ) {
            Class[] types = new Class [] {
        ...
        tblMatchButton.setBackground(new java.awt.Color(153, 204, 255));
        tblMatchButton.setFont(new java.awt.Font("Times New Roman", 1, 24)); // NOI18N
        tblMatchButton.setText("Find Match");
        tblMatchButton.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        tblMatchButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tblMatchButtonActionPerformed(evt);
            }
        });
        add(tblMatchButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 270, 260, -1));
        ...
        add(btnInform, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 550, 260, -1));
        ...
        add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 700, 110, -1));
    }// </editor-fold>//GEN-END:initComponents

    private void tblMatchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tblMatchButtonActionPerformed
    ...
    }//GEN-LAST:event_tblMatchButtonActionPerformed
    ...
    private void btnInformActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInformActionPerformed
        ...
        if (selectedRow >= 0) {
            donorEmail = (Donor) tbldonorInfo.getValueAt(selectedRow, 0);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int number1 = this.tbldonorInfo.getRowCount();
    ...
    private javax.swing.JButton tblMatchButton;
